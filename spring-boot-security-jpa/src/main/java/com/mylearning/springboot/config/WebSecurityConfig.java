package com.mylearning.springboot.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		//When the user has logged in as XX but access a page that requires role YY, AccessDeniedException will be thrown
		...
		http.authorizeRequests().and().formLogin()
		    ...
		    .loginPage("/login").defaultSuccessUrl("/userAccountInfo").failureUrl("/login?error=true")
